...
def saveFileRSC(base_list):
    ...
    listEnd.append("remove [find list=whatsapp]"+ "\n")

    for i in base_list:
        listEnd.append("add list=whatsapp address=" + i)

    finalFile = open("list/whatsapp_cidr_ipv4.rsc", "w+", encoding='utf-8', newline='\n')
...
def saveFileList(base_list, format) -> None:
    ...
    finalFile = open("list/whatsapp_cidr_ipv4." + format, "w+", encoding='utf-8', newline='\n')
    finalFile.writelines(listEnd)
    finalFile.close()
...
def saveFileListDomain(base_list, format) -> None:
    ...
    finalFile = open("list/whatsapp_domainlist." + format, "w+", encoding='utf-8', newline='\n')
    finalFile.writelines(listEnd)
    finalFile.close()
